...
const envSchema = z.object({
  ...
  NEXT_AUTH_URL: z.string().nonempty("Next auth url is empty"),
  ...
  EMAIL: z.string().nonempty("Email is empty").email("Email is not valid"),
  EMAIL_PASSWORD: z.string().nonempty("Email password is empty"),
